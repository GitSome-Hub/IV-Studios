...
Config.DeathTime = 3                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.ReviveInterval = 3                                  -- How long the timer is for players to revive a player in laststand
Config.MinimumRevive = 3                                   -- How long the timer is for players to revive a player in laststand
Config.PainkillerInterval = 120                               -- Set the length of time painkillers last (per one)
...
Config.AlwaysBleedChance = 65                                -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
