Config = {
    ...
    ------ QBCORE ONLY ------
    -------------------------
    AutoCreateQBSharedGang = false, -- Set to true if you want that the script auto create the gang that are in QBCore/shared/gang.lua file into this database
    ...
    RemoveOrganizationWhenEveryMembersLeaveIt = false, -- Will remove the organization from database and set neutral all the zone when all the members of an organization leave it
